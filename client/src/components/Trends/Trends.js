...
function Trends() {
    return (
        ...
        <div className='row trend-cards' style={{ backgroundColor: 'rgb(83, 155, 183)'}}>
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5  ms-5'>Fashion..</h4>
                <Link to='/fashion'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5  ms-5'>SkinCare..</h4>
                <Link to='/skincare'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5 ms-5'>Shoes..</h4>
                <Link to='/shoes'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5 ms-5'>HairCare..</h4>
                <Link to='/haircare'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5 ms-5'>Accesories..</h4>
                <Link to='/accesories'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5 ms-5'>Watches..</h4>
                <Link to='/watches'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5 ms-5'>Makeup..</h4>
                <Link to='/makeup'>
            ...
            <div className='col col-sm-6 col-md-6 col-lg-3'>
            <h4 className='position-absolute fst-italic mt-5 ms-5'>Home Decor..</h4>
                <Link to='/homedecor'>
